...
const LANGS: LangSpec[] = [
  // ===== スクリプト系 =====
  {
    ...
    frameworks: [
      ["Node.js", 8, "node", "web"],
      ["Express", 9, "express", "web"],
      ["Vue", 11, "vue", "web"],
      ["Svelte", 14, "svelte", "web"],
    ],
    oss: 18,
    cert: ["JavaScript 認定 (JSNAD)", 35],
  },
  {
    id: "ts",
    name: "TypeScript",
    ...
    concepts: [
      ...
      ["ジェネリクス", 6],
      ["型ガード", 9],
      ["Conditional Types", 14],
    ],
    libraries: [["Zod", 8]],
    frameworks: [
      ["React", 5, "react", "web"],
      ["Next.js", 10, "nextjs", "web"],
      ["Angular", 13, "angular", "web"],
    ],
    oss: 20,
    cert: ["TypeScript 認定", 38],
  },
  {
    id: "python",
    name: "Python",
    ...
    frameworks: [
      ["Flask", 6, "flask", "web"],
      ["Django", 9, "django", "web"],
      ["FastAPI", 10, "fastapi", "web"],
      ["scikit-learn", 12, "sklearn", "ai"],
      ["PyTorch", 16, "pytorch", "ai"],
      ["TensorFlow", 16, "tensorflow", "ai"],
    ],
    oss: 16,
    cert: ["Python エンジニア認定", 36],
  },
  {
    id: "ruby",
    name: "Ruby",
    ...
    libraries: [["RSpec", 5]],
    frameworks: [
      ["Sinatra", 6, undefined, "web"],
      ["Ruby on Rails", 8, "rails", "web"],
    ],
    oss: 20,
    cert: ["Ruby 技術者認定", 34],
  },
  {
    ...
    frameworks: [
      ["Laravel", 7, "laravel", "web"],
      ["Symfony", 12, "symfony", "web"],
    ],
    oss: 22,
    cert: ["PHP 技術者認定", 32],
  },
  ...
  },
  {
    ...
    frameworks: [
      ["Tokio", 12],
      ["Actix", 14, undefined, "web"],
      ["Embassy", 16, undefined, "embedded"],
    ],
    oss: 22,
    cert: ["Rust 認定", 40],
  },
  ...
  },
  {
    ...
    frameworks: [
      ["Ktor", 10, "ktor", "web"],
      ["Jetpack Compose", 12, "compose", "mobile"],
    ],
    oss: 22,
    cert: ["Kotlin 認定", 36],
  },
  ...
  // ===== ネイティブ / モバイル =====
  {
    ...
    frameworks: [
      ["UIKit", 6, undefined, "mobile"],
      ["SwiftUI", 9, undefined, "mobile"],
    ],
    oss: 22,
    cert: ["Swift 認定", 36],
  },
  ...
  for (const l of LANGS) {
    ...
    for (const [name, level, icon, platform] of l.frameworks ?? []) {
      ...
      out.push({
        ...
        xp: fxp,
        url: TECH_URLS[name],
        ...(platform ? { xpAlso: { skill: `plat_${platform}`, xp: Math.round(fxp * 0.6) } } : {}),

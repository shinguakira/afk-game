...
import { ACTION_MAP, CLASS_MAP, ITEM_MAP, MONSTER_MAP, PRESTIGE_MAP, SKILLS } from "./data";
...
import { FARM_CROP_MAP, PLOT_COUNT } from "./data/farming";
...
import { advancePlots, runCombatTick, runSkillTick, toastLevelUp } from "./tick";
import {
  HP_PER_MENTAL_LEVEL,
  LOG_LIMIT,
  MAX_OFFLINE_MS,

...
export const ITEMS: Item[] = [
  ...
  { id: "grape_juice", name: "ぶどうジュース", type: "food", icon: "grape_juice", sellPrice: 16, heals: 24 },
  { id: "homemade_energy", name: "自家製エナジードリンク", type: "food", icon: "energy_home", sellPrice: 28, heals: 42 },
];

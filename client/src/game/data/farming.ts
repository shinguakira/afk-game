...
export const FARM_CROPS: FarmCrop[] = [
  { id: "tomato", level: 1, growMs: 45_000, yield: 3, xp: 20 },
  { id: "rice", level: 2, growMs: 60_000, yield: 4, xp: 26 },
  { id: "carrot", level: 3, growMs: 55_000, yield: 3, xp: 30 },
  { id: "edamame", level: 5, growMs: 70_000, yield: 3, xp: 40 },
  { id: "dough", level: 6, growMs: 80_000, yield: 3, xp: 46 }, // 小麦→製粉
  { id: "shiitake", level: 8, growMs: 95_000, yield: 3, xp: 58 },
  { id: "strawberry", level: 10, growMs: 115_000, yield: 4, xp: 72 },
  { id: "apple", level: 13, growMs: 145_000, yield: 5, xp: 96 },
];
